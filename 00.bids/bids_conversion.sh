...
Usage() {
    ...
    echo 
    echo "list.txt is a file containing the name of the TEBC-5Y raw data folders to convert"
    echo "TEBC-5Y-8035"
    echo "TEBC-5Y-8036"
	echo "..."
    echo
...
bidsDir="/EBC/preprocessedData/TEBC-5y/BIDs_data" 				# BIDs_data has some modifications to the diffusion data
tmpDir="${bidsDir}/tmp"											# temporary directory to transfer raw data to for BIDS conversion

# define number of dicoms per functional run
pixar_dicoms=324
sesame_dicoms=394
