...
# define directories
dataDir="/EBC/rawData/TEBC-5y-adultpilot/"						# location of raw data
toolDir="/EBC/processing/tools"									# location of shared tools (dcm2bids)
bidsDir="/EBC/preprocessedData/TEBC-5y-adultpilot/BIDs_data" 	# BIDs_data has some modifications to the diffusion data
