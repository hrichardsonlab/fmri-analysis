...
def create_firstlevel_workflow(projDir, derivDir, workDir, outDir, 
                               ...
                               regressor_opts, smoothing_kernel_size, hpf, TR, dropvols, sparse,
    ...
    def gen_model_info(event_file, events, confound_file, regressor_names, dropvols):
        """Defines `SpecifyModel` information from BIDS events."""
        import pandas as pd
        from nipype.interfaces.base import Bunch
        
        # read in events file and identify trial types specified in config file
    ...
    if 'art' in regressor_opts:
        ...
        wf.connect(datasource, 'outlier_file', modelspec, 'outlier_files') # generated using rapidart in motion exclusions script
...
def process_subject(layout, projDir, derivDir, outDir, workDir, 
                    ...
                    regressor_opts, smoothing_kernel_size, hpf, dropvols, sparse):
...
def main(argv=None):
    ...
    for index, sub in enumerate(subjects):
        ...
        wf = process_subject(layout, args.projDir, derivDir, outDir, workDir, 
                             sub, task, ses, sub_runs, events, contrast_opts,
                             regressor_opts, smoothing_kernel_size, hpf, dropvols, args.sparse)
