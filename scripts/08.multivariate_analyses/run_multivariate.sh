...
################################################################################
# RUN MULTIVARIATE PIPELINES CALLING THE PIPELINE SCRIPT OF INTEREST
#
# This script runs the multivariate pipeline specified in the command call within a nipype singularity
...
Usage() {
	...
	echo
	echo "RLABAWE1_subjs.txt is a subject-run or subject-fold file containing the participants and run or fold info to process:"
	echo "sub-001 1,2"
	echo "sub-002 1,2"
	echo "..."
	echo
...
codeDir="${projDir}/scripts/08.multivariate_analyses"
...
# run multivariate workflow using script specified in script call
